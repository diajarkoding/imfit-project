 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\UserWeight> $userWeights
 * @property-read int|null $user_weights_count
...
class User extends Authenticatable implements FilamentUser, HasName
{
     ...
     * Only users with is_admin = 1 can access.
     */
